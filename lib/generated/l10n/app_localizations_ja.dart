...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get inviteCodeHint =>
      'このコードを共有してください。相手がログイン後、家族の設定で「招待コードがある」を選び、入力すると参加できます。';

  @override
  String get familyRoleOwner => '管理者';

  @override
  String get familyRoleMember => 'メンバー';
  ...
  @override
  String get notificationsLoadFailed => '通知を読み込めませんでした。下に引いて再試行してください。';

  @override
  String get postPublishedSuccess => '投稿を公開しました。';

  @override
  String get postStatusScheduled => '予約投稿';

  @override
  String get myPostsLoadFailed => '投稿を読み込めませんでした。もう一度お試しください。';
}
