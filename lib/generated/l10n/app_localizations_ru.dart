...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get notificationsLoadFailed =>
      'Не удалось загрузить уведомления. Потяните вниз для обновления.';

  @override
  String get postPublishedSuccess => 'Публикация опубликована.';

  @override
  String get postStatusScheduled => 'По расписанию';

  @override
  String get myPostsLoadFailed =>
      'Не удалось загрузить публикации. Повторите попытку.';
}
